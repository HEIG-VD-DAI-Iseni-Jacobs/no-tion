...
//                    System.out.println("Commande inconnue. Tapez HELP pour la liste des
// commandes.");
//                    continue;
//                }
//
//                if (!connected && command != Command.CONNECT && command != Command.QUIT && command
// != Command.HELP) {
//                    System.out.println("Vous devez d'abord vous connecter avec la commande
// CONNECT.");
//                    continue;
//                }
//
...
//                        return;
//                    }
//                    default -> System.out.println("Commande inconnue. Tapez HELP pour la liste des
// commandes.");
//                }
//            }
//
...
//        System.out.println("  CONNECT <nom_utilisateur>         - Se connecter au serveur avec le
// nom d'utilisateur spécifié.");
//        System.out.println("  DISCONNECT                        - Se déconnecter du serveur.");
//        System.out.println("  CREATE_NOTE <titre>               - Créer une nouvelle note avec le
// titre spécifié.");
//        System.out.println("  DELETE_NOTE <titre>               - Supprimer la note avec le titre
// spécifié.");
//        System.out.println("  LIST_NOTES                        - Lister toutes les notes
// existantes.");
//        System.out.println("  GET_NOTE <index>                  - Récupérer le contenu de la note
// à l'index spécifié.");
//        System.out.println("  UPDATE_CONTENT <index> <contenu>  - Mettre à jour le contenu de la
// note à l'index spécifié.");
//        System.out.println("  UPDATE_TITLE <index> <titre>      - Mettre à jour le titre de la
// note à l'index spécifié.");
...
//                        host = args[++i];
//                    } else {
//                        System.err.println("Option -H ou --host nécessite un argument.");
//                    }
//                }
//                case "-p", "--port" -> {
//                    if (i + 1 < args.length) {
...
//                        }
//                    } else {
//                        System.err.println("Option -p ou --port nécessite un argument.");
//                    }
//                }
//            }
//        }
